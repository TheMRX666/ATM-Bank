...
public class ATM {
    ...
    public static void main(String[] args) {
        ...
        User newUser = theBank.addUser("Ruslan", "DEVops", "6867");
        Account newAccount = new Account ("savings" , newUser , theBank);
        newUser.addAccount(newAccount);
        theBank.addAccount(newAccount);
        User curUser;
        while (true){
            curUser = ATM.menuPrompt(theBank ,scan );
    ...
    public static  User menuPrompt(Bank theBank , Scanner scan ){
        String userID ;
        String pin ;
        User authUser;
        do{
    ...
    public static void printUserMenu(User theUser , Scanner scan ){
        ...
        switch (choice){
            case 1 :
                ATM.showAccountTransactionHistory(theUser , scan);
                break ;
            ...
            case 3 :
                ATM.depositeFunds(theUser , scan);
                break ;
            case 4 :
    ...
    public static void depositeFunds(User theUser , Scanner scan){
        int toAcct;
        double amount;
        double acctBal;
        String memo;
